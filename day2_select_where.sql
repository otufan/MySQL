...
/*-----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
 -- eski method ile yapilabilir ama case sensitive degildir
 select * from kelimeler
 where kelime like 'h_t';

select * from kelimeler
where regexp_like(kelime, 'h[a-zA-Z0-9]t' , 'c');
-- [a-zA-Z0-9] bu ifade sadece bir karakter icin. her karakter icin tekrar koseli parantezli ifade edilecek
